...
<div class="row">
	<div class="five columns end">
    	<form name="form_login" id="form_login" action="" method="POST">
        	<fieldset>
          	<legend><?php lang('THE SOLVE 3xB Inventario - "Tu empresa"'); ?></legend>
    
              <label for="user_name"><?php lang('Usuario'); ?></label>
              <input type="text" name="user_name" id="user_name" class="required" minlength="3" maxlength="20" placeholder="admin" />
    
              <label for="password"><?php lang('Clave'); ?></label>
              <input type="password" name="password" id="password" class="required"  minlength="3" maxlength="20" placeholder="123456" />          
