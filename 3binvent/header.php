...
<head>
  ...
  <script src="<?php url('theme'); ?>/javascripts/angular.min.js"></script>
...
<div class="row">
	<div class="twelve columns">
        <ul class="nav-bar">
          ...
          <li class="has-flyout">
            <a href="#"><?php lang('Producto'); ?></a>
            <a href="#" class="flyout-toggle"><span> </span></a>
            <ul class="flyout">
            	<li><a href="<?php url('page'); ?>/product/add.php"><?php lang('Agregar Producto'); ?></a></li>
                <li><a href="<?php url('page'); ?>/product/product_list.php"><?php lang('Todos los Productos'); ?></a></li>
                <li><a href="<?php url('page'); ?>/product/lote.php"><?php lang('Productos por lote'); ?></a></li>
                 </a></li>
            </ul>
          </li>
           <li class="has-flyout">
            ...
            <a href="#" class="flyout-toggle"><span> </span></a>
            <ul class="flyout">
              <li><a href="<?php url('page'); ?>/input-output/input-output.php?input"><?php lang('Entrada'); ?></a></li>
                <li><a href="<?php url('page'); ?>/input-output/input-output.php?output"><?php lang('Salida'); ?></a></li>
            </ul>
          </li>
      <li class="has-flyout">
...
<div class="row">
	<div class="twelve columns">
		...
		{
			alert_box('alert', get_lang('NO tienes permiso para acceder a esta pagina'));
			exit;
		}
		?>
    </div>
