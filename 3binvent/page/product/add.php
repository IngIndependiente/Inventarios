    	...
    	<fieldset>
            ...
            <input ng-model="over_stock" type="number" name="over_stock" id="over_stock" maxlength="20" minlength="1" />
                ...
                <div class="six columns">
                    <label for="purchase_price"><?php lang('Price'); ?></label>
