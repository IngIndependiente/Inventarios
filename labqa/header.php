	...
	<div class="twelve columns">
        <ul class="nav-bar">
          ...
          <li class="has-flyout">
            ...
            <ul class="flyout">
            	<li><a href="<?php url('page'); ?>/product/add.php"><?php lang('Agregar Muestra'); ?></a></li>
                <li><a href="<?php url('page'); ?>/product/product_list.php"><?php lang('Todos las Muestras'); ?></a></li>
                <li><a href="<?php url('page'); ?>/product/lote.php"><?php lang('Muestras por lote'); ?></a></li>
                 </a></li>
            </ul>
          </li>
           <li class="has-flyout">
